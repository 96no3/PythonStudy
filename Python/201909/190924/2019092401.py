...
class Node:
    ...
    def calculate(self):
        ...
        left_operand  = str(self.left.expression)
        right_operand = str(self.right.expression)
...
def test_exec():
    while True:
        ...
        try:
            ...
            root.parse()
            print(f"expression2: {root.expression}")
